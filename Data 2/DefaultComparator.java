 ...
 */
public class DefaultComparator<Integer> implements Comparator<Integer> {
  ...
  public int compare(Integer a, Integer b) throws ClassCastException {
	//I have changed the compare method
	//To return the contrary   
	//In order to get the max index instead of min  
